...
SceneObject::SceneObject(Graphics& gfx, float radius, int latDiv, int longDiv, const char* vs, const char* ps, float pos[3], const char* gs)
	:
...
void SceneObject::Reset() noexcept
{
}

void SceneObject::Draw(Graphics& gfx) const noexcept
{
...
void SceneObject::Bind(Graphics& gfx, DirectX::FXMMATRIX view, float musParams[3]) const noexcept
{
