...
public:
	...
	IndexedTriangleList(hw3dexp::VertexBuffer verts_in, std::vector<unsigned short> indices_in)
		:
	...
	{
		using Elements = hw3dexp::VertexLayout::ElementType;
	...
	void SetNormalsIndependentFlat()
	{
		...
		using Type = hw3dexp::VertexLayout::ElementType;
