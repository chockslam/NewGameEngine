...
{
public:
	static IndexedTriangleList MakeTesselated(hw3dexp::VertexLayout layout, int latDiv, int longDiv)
	{
		...
		hw3dexp::VertexBuffer vb{ std::move(layout) };
	...
	static IndexedTriangleList Make(std::optional<hw3dexp::VertexLayout> layout = std::nullopt)
	{
		using Element = hw3dexp::VertexLayout::ElementType;
		if (!layout)
		{
			layout = hw3dexp::VertexLayout{}.Append(Element::Position3D);
		}
